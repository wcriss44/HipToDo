...
import com.theironyard.novauc.repository.OwnerRepository;
...
public class OwnerResourceIntTest {
    ...
    private static final String DEFAULT_SERVICE_BRANCH = "AAAAAAAAAA";
    private static final String UPDATED_SERVICE_BRANCH = "BBBBBBBBBB";
    ...
    public static Owner createEntity(EntityManager em) {
        Owner owner = new Owner()
            .name(DEFAULT_NAME)
            .serviceBranch(DEFAULT_SERVICE_BRANCH)
    ...
    public void createOwner() throws Exception {
        ...
        assertThat(testOwner.getServiceBranch()).isEqualTo(DEFAULT_SERVICE_BRANCH);
    ...
    @Test
    @Transactional
    public void checkServiceBranchIsRequired() throws Exception {
        int databaseSizeBeforeTest = ownerRepository.findAll().size();
        // set the field null
        owner.setServiceBranch(null);
    ...
    public void getAllOwners() throws Exception {
        ...
        restOwnerMockMvc.perform(get("/api/owners?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].serviceBranch").value(hasItem(DEFAULT_SERVICE_BRANCH.toString())))
    ...
    public void getOwner() throws Exception {
        ...
        restOwnerMockMvc.perform(get("/api/owners/{id}", owner.getId()))
            ...
            .andExpect(jsonPath("$.serviceBranch").value(DEFAULT_SERVICE_BRANCH.toString()))
    ...
    public void updateOwner() throws Exception {
        ...
        updatedOwner
            .name(UPDATED_NAME)
            .serviceBranch(UPDATED_SERVICE_BRANCH)
        ...
        assertThat(testOwner.getServiceBranch()).isEqualTo(UPDATED_SERVICE_BRANCH);
